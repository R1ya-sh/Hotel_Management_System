    ...
    public partial class UserControlClient : UserControl
    {
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            if (ID != "")
            {
                ...
                {
                    DialogResult result = MessageBox.Show("Do you want to Delete this Client?", "Client delete", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
        ...
        private void tabPageSearchClient_TextChanged(object sender, EventArgs e)
        {
