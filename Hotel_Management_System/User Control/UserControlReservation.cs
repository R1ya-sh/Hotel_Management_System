    ...
    public partial class UserControlReservation : UserControl
    {
        ...
        private void buttonAdd_Click(object sender, EventArgs e)
        {
            ...
            if (comboBoxType.SelectedIndex==0|| comboBoxNo.SelectedIndex==0||textBoxClientID.Text.Trim()==string.Empty)
                MessageBox.Show("Please fill out all the fields.", "Require all fields.", MessageBoxButtons.OK, MessageBoxIcon.Information);
            else
            {
        ...
        {
            db.DisplayAndSearch("SEARCH * FROM Reservation_Table WHERE Reservation_Client_ID LIKE '%" + textBoxSearchClientID.Text + "%'", dataGridViewReservation);
        }
        ...
        private void buttonCancel_Click(object sender, EventArgs e)
        {
            ...
            if (RID != "")
            {
                ...
                {
                    DialogResult result = MessageBox.Show("Do you want to Cancel this Reservation?", "Reservation Cancel", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
