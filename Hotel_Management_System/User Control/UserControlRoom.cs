...
namespace Hotel_Management_System.User_Control
{
    public partial class UserControlRoom : UserControl
    {
        ...
        private void tabPageSearchRoom_TextChanged(object sender, EventArgs e)
        {
        ...
        private void buttonDelete_Click(object sender, EventArgs e)
        {
            ...
            if (No != "")
            {
                ...
                {
                    DialogResult result = MessageBox.Show("Do you want to Delete this Room?", "Room delete", MessageBoxButtons.YesNo, MessageBoxIcon.Question);
